...
from clean_naming import get_model_name
from wandb_api import get_runs_df, has_tags, topk_run_of_each_model_type, hasnt_tags, has_hyperparam_values, \
...
for tag in TAGS:
    ...
    model_stats = runs_df[runs_df['tags'].str.contains(tag)]
